...
class TestFactory(unittest.TestCase):
    def test_spider(self):
        ...
        self.assertEqual(spider.update.__doc__,
    ...
    def test_archer(self):
        ...
        self.assertEqual(archer.update.__doc__, "no move")
    ...
    def test_bee(self):
        ...
        self.assertEqual(bee.update.__doc__,
    ...
    def test_scorpion(self):
        ...
        self.assertEqual(scorpion.update.__doc__, "moves to the character")
    ...
    def test_zombie(self):
        ...
        self.assertEqual(zombie.update.__doc__, "go to character")
